...
typedef struct __mavlink_utm_global_position_t {
 ...
 uint16_t update_rate; /*< [cs] Time until next update. Set to 0 if unknown or in data
                driven mode.
            */
 ...
 * @param update_rate [cs] Time until next update. Set to 0 if unknown or in data
                driven mode.
 ...
 *
 * @return [cs] Time until next update. Set to 0 if unknown or in data
                driven mode.
