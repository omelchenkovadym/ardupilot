...
typedef struct __mavlink_mount_orientation_t {
 ...
 float yaw_absolute; /*< [deg] Yaw in absolute frame relative to Earth's North, north
                is 0 (set to NaN for invalid).
            */
 ...
 * @param yaw_absolute [deg] Yaw in absolute frame relative to Earth's North, north
                is 0 (set to NaN for invalid).
 ...
 *
 * @return [deg] Yaw in absolute frame relative to Earth's North, north
                is 0 (set to NaN for invalid).
