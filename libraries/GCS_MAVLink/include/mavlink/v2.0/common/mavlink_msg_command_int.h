...
typedef struct __mavlink_command_int_t {
 ...
 int32_t x; /*<  PARAM5 / local: x position in meters * 1e4, global: latitude in degrees *
                10^7
            */
 int32_t y; /*<  PARAM6 / local: y position in meters * 1e4, global: longitude in degrees *
                10^7
            */
 ...
 * @param y  PARAM6 / local: y position in meters * 1e4, global: longitude in degrees *
                10^7
 ...
 *
 * @return  PARAM6 / local: y position in meters * 1e4, global: longitude in degrees *
                10^7
