...
typedef struct __mavlink_rc_channels_scaled_t {
 ...
 uint8_t port; /*<  Servo output port (set of 8 outputs = 1 port). Flight stacks running on
            ...
            */
 uint8_t rssi; /*<  Receive signal strength indicator in device-dependent units/scale. Values:
 ...
 * @param port  Servo output port (set of 8 outputs = 1 port). Flight stacks running on
                Pixhawk should use: 0 = MAIN, 1 = AUX.
 ...
 * @param rssi  Receive signal strength indicator in device-dependent units/scale. Values:
                [0-254], 255: invalid/unknown.
 ...
 *
 * @return  Servo output port (set of 8 outputs = 1 port). Flight stacks running on
                Pixhawk should use: 0 = MAIN, 1 = AUX.
 ...
 *
 * @return  Receive signal strength indicator in device-dependent units/scale. Values:
                [0-254], 255: invalid/unknown.
