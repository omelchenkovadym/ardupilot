...
typedef struct __mavlink_smart_battery_info_t {
 int32_t capacity_full_specification; /*< [mAh] Capacity when full according to
                manufacturer, -1: field not provided.
            */
 int32_t capacity_full; /*< [mAh] Capacity when full (accounting for battery
 ...
 uint16_t discharge_minimum_voltage; /*< [mV] Minimum per-cell voltage when
                discharging. If not supplied set to UINT16_MAX value.
            */
 uint16_t charging_minimum_voltage; /*< [mV] Minimum per-cell voltage when charging. If
                not supplied set to UINT16_MAX value.
            */
 uint16_t resting_minimum_voltage; /*< [mV] Minimum per-cell voltage when resting. If
                not supplied set to UINT16_MAX value.
            */
 uint8_t id; /*<  Battery ID*/
 uint8_t battery_function; /*<  Function of the battery*/
 uint8_t type; /*<  Type (chemistry) of the battery*/
 char serial_number[16]; /*<  Serial number in ASCII characters, 0 terminated. All 0: field
                not provided.
            */
 char device_name[50]; /*<  Static device name in ASCII characters, 0 terminated. All 0: field
                not provided. Encode as manufacturer name then product name separated using an underscore.
            */
 uint16_t charging_maximum_voltage; /*< [mV] Maximum per-cell voltage when charged. 0:
                field not provided.
            */
 uint8_t cells_in_series; /*<  Number of battery cells in series. 0: field not provided.
            */
 uint32_t discharge_maximum_current; /*< [mA] Maximum pack discharge current. 0: field
                not provided.
            */
 uint32_t discharge_maximum_burst_current; /*< [mA] Maximum pack discharge burst
                current. 0: field not provided.
            */
 char manufacture_date[11]; /*<  Manufacture date (DD/MM/YYYY) in ASCII characters, 0
 ...
 * @param capacity_full_specification [mAh] Capacity when full according to
                manufacturer, -1: field not provided.
            
 * @param capacity_full [mAh] Capacity when full (accounting for battery
                degradation), -1: field not provided.
            
 * @param cycle_count  Charge/discharge cycle count. UINT16_MAX: field not provided.
            
 * @param serial_number  Serial number in ASCII characters, 0 terminated. All 0: field
                not provided.
            
 * @param device_name  Static device name in ASCII characters, 0 terminated. All 0: field
                not provided. Encode as manufacturer name then product name separated using an underscore.
            
 * @param weight [g] Battery weight. 0: field not provided.
 * @param discharge_minimum_voltage [mV] Minimum per-cell voltage when
                discharging. If not supplied set to UINT16_MAX value.
            
 * @param charging_minimum_voltage [mV] Minimum per-cell voltage when charging. If
                not supplied set to UINT16_MAX value.
            
 * @param resting_minimum_voltage [mV] Minimum per-cell voltage when resting. If
                not supplied set to UINT16_MAX value.
            
 * @param charging_maximum_voltage [mV] Maximum per-cell voltage when charged. 0:
                field not provided.
            
 * @param cells_in_series  Number of battery cells in series. 0: field not provided.
            
 * @param discharge_maximum_current [mA] Maximum pack discharge current. 0: field
                not provided.
            
 * @param discharge_maximum_burst_current [mA] Maximum pack discharge burst
                current. 0: field not provided.
            
 * @param manufacture_date  Manufacture date (DD/MM/YYYY) in ASCII characters, 0
                terminated. All 0: field not provided.
 ...
 *
 * @return [mAh] Capacity when full according to
                manufacturer, -1: field not provided.
 ...
 *
 * @return [mAh] Capacity when full (accounting for battery
                degradation), -1: field not provided.
 ...
 *
 * @return  Serial number in ASCII characters, 0 terminated. All 0: field
                not provided.
 ...
 *
 * @return  Static device name in ASCII characters, 0 terminated. All 0: field
                not provided. Encode as manufacturer name then product name separated using an underscore.
 ...
 *
 * @return [mV] Minimum per-cell voltage when
                discharging. If not supplied set to UINT16_MAX value.
 ...
 *
 * @return [mV] Minimum per-cell voltage when charging. If
                not supplied set to UINT16_MAX value.
 ...
 *
 * @return [mV] Minimum per-cell voltage when resting. If
                not supplied set to UINT16_MAX value.
 ...
 *
 * @return [mV] Maximum per-cell voltage when charged. 0:
                field not provided.
 ...
 *
 * @return [mA] Maximum pack discharge current. 0: field
                not provided.
 ...
 *
 * @return [mA] Maximum pack discharge burst
                current. 0: field not provided.
 ...
 *
 * @return  Manufacture date (DD/MM/YYYY) in ASCII characters, 0
                terminated. All 0: field not provided.
