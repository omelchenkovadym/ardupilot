...
typedef struct __mavlink_memory_vect_t {
 ...
 uint8_t ver; /*<  Version code of the type variable. 0=unknown, type ignored and assumed
                int16_t. 1=as below
            */
 ...
 * @param ver  Version code of the type variable. 0=unknown, type ignored and assumed
                int16_t. 1=as below
            
 * @param type  Type code of the memory variables. for ver = 1: 0=16 x int16_t, 1=16 x
                uint16_t, 2=16 x Q15, 3=16 x 1Q14
 ...
 *
 * @return  Version code of the type variable. 0=unknown, type ignored and assumed
                int16_t. 1=as below
 ...
 *
 * @return  Type code of the memory variables. for ver = 1: 0=16 x int16_t, 1=16 x
                uint16_t, 2=16 x Q15, 3=16 x 1Q14
