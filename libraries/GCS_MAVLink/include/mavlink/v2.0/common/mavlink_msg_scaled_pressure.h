...
typedef struct __mavlink_scaled_pressure_t {
 ...
 int16_t temperature_press_diff; /*< [cdegC] Differential pressure temperature (0, if
                not available). Report values of 0 (or 1) as 1 cdegC.
            */
 ...
 * @param temperature_press_diff [cdegC] Differential pressure temperature (0, if
                not available). Report values of 0 (or 1) as 1 cdegC.
 ...
 *
 * @return [cdegC] Differential pressure temperature (0, if
                not available). Report values of 0 (or 1) as 1 cdegC.
