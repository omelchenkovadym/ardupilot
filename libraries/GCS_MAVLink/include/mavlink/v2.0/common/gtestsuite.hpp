...
TEST(common, RADIO_SIGNAL)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::RADIO_SIGNAL packet_in{};
    packet_in.rate = 17.0;
    packet_in.heading = 17443;
    packet_in.level = 17547;

    mavlink::common::msg::RADIO_SIGNAL packet1{};
    mavlink::common::msg::RADIO_SIGNAL packet2{};
    ...
    EXPECT_EQ(packet1.rate, packet2.rate);
    EXPECT_EQ(packet1.heading, packet2.heading);
    EXPECT_EQ(packet1.level, packet2.level);
}

#ifdef TEST_INTEROP
TEST(common_interop, RADIO_SIGNAL)
{
    mavlink_message_t msg;
    ...
    mavlink_radio_signal_t packet_c {
         17.0, 17443, 17547
    };
    ...
    mavlink_msg_radio_signal_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.rate, packet2.rate);
    EXPECT_EQ(packet_in.heading, packet2.heading);
