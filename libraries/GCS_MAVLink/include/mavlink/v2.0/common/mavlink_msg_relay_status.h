...
typedef struct __mavlink_relay_status_t {
 ...
 uint16_t on; /*<  Relay states. Relay instance numbers are represented as
                individual bits in this mask by offset.
            */
 uint16_t present; /*<  Relay present. Relay instance numbers are
                represented as individual bits in this mask by offset. Bits will be true if a relay instance is
                configured.
            */
 ...
 * @param on  Relay states. Relay instance numbers are represented as
                individual bits in this mask by offset.
            
 * @param present  Relay present. Relay instance numbers are
                represented as individual bits in this mask by offset. Bits will be true if a relay instance is
                configured.
 ...
 *
 * @return  Relay states. Relay instance numbers are represented as
                individual bits in this mask by offset.
 ...
 *
 * @return  Relay present. Relay instance numbers are
                represented as individual bits in this mask by offset. Bits will be true if a relay instance is
                configured.
