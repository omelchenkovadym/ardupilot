...
typedef struct __mavlink_flight_information_t {
 uint64_t arming_time_utc; /*< [us] Timestamp at arming (time since UNIX epoch) in UTC,
                0 for unknown
            */
 uint64_t takeoff_time_utc; /*< [us] Timestamp at takeoff (time since UNIX epoch) in
                UTC, 0 for unknown
            */
 uint64_t flight_uuid; /*<  Universally unique identifier (UUID) of flight, should correspond
                to name of log files
            */
 ...
 * @param arming_time_utc [us] Timestamp at arming (time since UNIX epoch) in UTC,
                0 for unknown
            
 * @param takeoff_time_utc [us] Timestamp at takeoff (time since UNIX epoch) in
                UTC, 0 for unknown
            
 * @param flight_uuid  Universally unique identifier (UUID) of flight, should correspond
                to name of log files
 ...
 *
 * @return [us] Timestamp at arming (time since UNIX epoch) in UTC,
                0 for unknown
 ...
 *
 * @return [us] Timestamp at takeoff (time since UNIX epoch) in
                UTC, 0 for unknown
 ...
 *
 * @return  Universally unique identifier (UUID) of flight, should correspond
                to name of log files
