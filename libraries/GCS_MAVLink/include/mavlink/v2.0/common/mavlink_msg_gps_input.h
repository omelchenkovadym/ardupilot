...
typedef struct __mavlink_gps_input_t {
 ...
 float hdop; /*<  GPS HDOP horizontal dilution of position (unitless). If unknown, set to:
                UINT16_MAX
            */
 float vdop; /*<  GPS VDOP vertical dilution of position (unitless). If unknown, set to:
                UINT16_MAX
            */
 ...
 * @param ignore_flags  Bitmap indicating
                which GPS input flags fields to ignore. All other fields must be provided.
 ...
 * @param hdop  GPS HDOP horizontal dilution of position (unitless). If unknown, set to:
                UINT16_MAX
            
 * @param vdop  GPS VDOP vertical dilution of position (unitless). If unknown, set to:
                UINT16_MAX
