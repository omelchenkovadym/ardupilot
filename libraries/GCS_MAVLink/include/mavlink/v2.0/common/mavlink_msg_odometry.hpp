...
struct ODOMETRY : mavlink::Message {
    ...
    std::array<float, 21> pose_covariance; /*<  Row-major representation of a 6x6 pose cross-covariance
             ...
             */
    std::array<float, 21> velocity_covariance; /*<  Row-major representation of a 6x6 velocity
