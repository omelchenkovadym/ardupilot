...
struct WIFI_CONFIG_AP : mavlink::Message {
    ...
    std::array<char, 32> ssid; /*<  Name of Wi-Fi network (SSID). Blank to leave it unchanged when setting.
                Current SSID when sent back as a response.
             */
    std::array<char, 64> password; /*<  Password. Blank for an open AP. MD5 hash when message is sent back as
                a response.
             */
