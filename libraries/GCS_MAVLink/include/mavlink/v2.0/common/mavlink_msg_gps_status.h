...
typedef struct __mavlink_gps_status_t {
 ...
 uint8_t satellite_elevation[20]; /*< [deg] Elevation (0: right on top of receiver, 90:
            ...
            */
 uint8_t satellite_azimuth[20]; /*< [deg] Direction of satellite, 0: 0 deg, 255: 360
                deg.
            */
 ...
 * @param satellite_azimuth [deg] Direction of satellite, 0: 0 deg, 255: 360
                deg.
 ...
 *
 * @return [deg] Direction of satellite, 0: 0 deg, 255: 360
                deg.
