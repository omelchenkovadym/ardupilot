...
typedef struct __mavlink_landing_target_t {
 uint64_t time_usec; /*< [us] Timestamp (UNIX Epoch time or time since system boot).
            ...
            */
 float angle_x; /*< [rad] X-axis angular offset of the target from the center of the
                image
            */
 float angle_y; /*< [rad] Y-axis angular offset of the target from the center of the
                image
            */
 ...
 float q[4]; /*<  Quaternion of landing target orientation (w, x, y, z order, zero-rotation is
                1, 0, 0, 0)
            */
 uint8_t type; /*<  Type of landing target*/
 uint8_t position_valid; /*<  Boolean indicating whether the position fields (x, y, z, q,
                type) contain valid target position information (valid: 1, invalid: 0). Default is 0 (invalid).
            */
 ...
 * @param angle_x [rad] X-axis angular offset of the target from the center of the
                image
            
 * @param angle_y [rad] Y-axis angular offset of the target from the center of the
                image
 ...
 * @param q  Quaternion of landing target orientation (w, x, y, z order, zero-rotation is
                1, 0, 0, 0)
            
 * @param type  Type of landing target
 * @param position_valid  Boolean indicating whether the position fields (x, y, z, q,
                type) contain valid target position information (valid: 1, invalid: 0). Default is 0 (invalid).
 ...
 *
 * @return [rad] X-axis angular offset of the target from the center of the
                image
 ...
 *
 * @return [rad] Y-axis angular offset of the target from the center of the
                image
 ...
 *
 * @return  Quaternion of landing target orientation (w, x, y, z order, zero-rotation is
                1, 0, 0, 0)
 ...
 *
 * @return  Boolean indicating whether the position fields (x, y, z, q,
                type) contain valid target position information (valid: 1, invalid: 0). Default is 0 (invalid).
