...
typedef struct __mavlink_generator_status_t {
 uint64_t status; /*<  Status flags.
            */
 float battery_current; /*< [A] Current into/out of battery. Positive for out. Negative
                for in. NaN: field not provided.
            */
 float load_current; /*< [A] Current going to the UAV. If battery current not available
                this is the DC current from the generator. Positive for out. Negative for in. NaN: field not provided
            */
 ...
 float bus_voltage; /*< [V] Voltage of the bus seen at the generator, or battery bus if
            ...
            */
 float bat_current_setpoint; /*< [A] The target battery current. Positive for out.
                Negative for in. NaN: field not provided
            */
 uint32_t runtime; /*< [s] Seconds this generator has run since it was rebooted.
                UINT32_MAX: field not provided.
            */
 int32_t time_until_maintenance; /*< [s] Seconds until this generator requires
                maintenance. A negative value indicates maintenance is past-due. INT32_MAX: field not provided.
            */
 uint16_t generator_speed; /*< [rpm] Speed of electrical generator or alternator.
                UINT16_MAX: field not provided.
            */
 int16_t rectifier_temperature; /*< [degC] The temperature of the rectifier or power
                converter. INT16_MAX: field not provided.
            */
 int16_t generator_temperature; /*< [degC] The temperature of the mechanical motor,
                fuel cell core or generator. INT16_MAX: field not provided.
            */
 ...
 * @param generator_speed [rpm] Speed of electrical generator or alternator.
                UINT16_MAX: field not provided.
            
 * @param battery_current [A] Current into/out of battery. Positive for out. Negative
                for in. NaN: field not provided.
            
 * @param load_current [A] Current going to the UAV. If battery current not available
                this is the DC current from the generator. Positive for out. Negative for in. NaN: field not provided
 ...
 * @param rectifier_temperature [degC] The temperature of the rectifier or power
                converter. INT16_MAX: field not provided.
            
 * @param bat_current_setpoint [A] The target battery current. Positive for out.
                Negative for in. NaN: field not provided
            
 * @param generator_temperature [degC] The temperature of the mechanical motor,
                fuel cell core or generator. INT16_MAX: field not provided.
            
 * @param runtime [s] Seconds this generator has run since it was rebooted.
                UINT32_MAX: field not provided.
            
 * @param time_until_maintenance [s] Seconds until this generator requires
                maintenance. A negative value indicates maintenance is past-due. INT32_MAX: field not provided.
 ...
 *
 * @return [rpm] Speed of electrical generator or alternator.
                UINT16_MAX: field not provided.
 ...
 *
 * @return [A] Current into/out of battery. Positive for out. Negative
                for in. NaN: field not provided.
 ...
 *
 * @return [A] Current going to the UAV. If battery current not available
                this is the DC current from the generator. Positive for out. Negative for in. NaN: field not provided
 ...
 *
 * @return [degC] The temperature of the rectifier or power
                converter. INT16_MAX: field not provided.
 ...
 *
 * @return [A] The target battery current. Positive for out.
                Negative for in. NaN: field not provided
 ...
 *
 * @return [degC] The temperature of the mechanical motor,
                fuel cell core or generator. INT16_MAX: field not provided.
 ...
 *
 * @return [s] Seconds until this generator requires
                maintenance. A negative value indicates maintenance is past-due. INT32_MAX: field not provided.
