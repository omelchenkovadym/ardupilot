...
typedef struct __mavlink_wind_cov_t {
 ...
 float var_horiz; /*< [m/s] Variability of the wind in XY. RMS of a 1 Hz lowpassed wind
                estimate.
            */
 float var_vert; /*< [m/s] Variability of the wind in Z. RMS of a 1 Hz lowpassed wind
                estimate.
            */
 ...
 * @param var_horiz [m/s] Variability of the wind in XY. RMS of a 1 Hz lowpassed wind
                estimate.
            
 * @param var_vert [m/s] Variability of the wind in Z. RMS of a 1 Hz lowpassed wind
                estimate.
 ...
 *
 * @return [m/s] Variability of the wind in XY. RMS of a 1 Hz lowpassed wind
                estimate.
 ...
 *
 * @return [m/s] Variability of the wind in Z. RMS of a 1 Hz lowpassed wind
                estimate.
