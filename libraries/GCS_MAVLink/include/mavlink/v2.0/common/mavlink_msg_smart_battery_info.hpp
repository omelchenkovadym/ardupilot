...
struct SMART_BATTERY_INFO : mavlink::Message {
    ...
    uint16_t cycle_count; /*<  Charge/discharge cycle count. UINT16_MAX: field not provided.
             */
    std::array<char, 16> serial_number; /*<  Serial number in ASCII characters, 0 terminated. All 0: field
                not provided.
             */
    std::array<char, 50> device_name; /*<  Static device name in ASCII characters, 0 terminated. All 0: field
    ...
    uint32_t discharge_maximum_burst_current; /*< [mA] Maximum pack discharge burst
             ...
             */
    std::array<char, 11> manufacture_date; /*<  Manufacture date (DD/MM/YYYY) in ASCII characters, 0
