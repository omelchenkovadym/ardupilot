...
typedef struct __mavlink_global_position_int_t {
 ...
 uint16_t hdg; /*< [cdeg] Vehicle heading (yaw angle), 0.0..359.99 degrees. If unknown,
                set to: UINT16_MAX
            */
 ...
 * @param alt [mm] Altitude (MSL). Note that virtually all GPS modules provide both
                WGS84 and MSL.
 ...
 * @param hdg [cdeg] Vehicle heading (yaw angle), 0.0..359.99 degrees. If unknown,
                set to: UINT16_MAX
 ...
 *
 * @return [mm] Altitude (MSL). Note that virtually all GPS modules provide both
                WGS84 and MSL.
 ...
 *
 * @return [cdeg] Vehicle heading (yaw angle), 0.0..359.99 degrees. If unknown,
                set to: UINT16_MAX
